...
def get_dataset(name = 'assist',batch_size = 32,ratio = 0.5):


    if ratio == 0.8:
        with open("./dataset/data/{}/{}_val_set.json".format(name,name), encoding='utf8') as i1_f:
            valid_data1 = json.load(i1_f)

        with open("./dataset/data/{}/{}_train_set.json".format(name,name), encoding='utf8') as i_f:
            train_data1 = json.load(i_f)

        with open("./dataset/data/{}/{}_test_set.json".format(name,name), encoding='utf8') as i2_f:
            test_data1 = json.load(i2_f)

    else:
        ratio = int(10*ratio)
        with open("./dataset/data/{}/{}_val_set_{}.json".format(name,name,ratio), encoding='utf8') as i1_f:
            valid_data1 = json.load(i1_f)

        with open("./dataset/data/{}/{}_train_set_{}.json".format(name,name,ratio), encoding='utf8') as i_f:
            train_data1 = json.load(i_f)

        with open("./datasetdata/{}/{}_test_set_{}.json".format(name,name,ratio), encoding='utf8') as i2_f:
            test_data1 = json.load(i2_f)



    item2knowledge = np.loadtxt("./dataset/data/{}/{}_item2knowledge.txt".format(name,name))
